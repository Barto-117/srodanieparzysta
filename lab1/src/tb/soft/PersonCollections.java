...
public class PersonCollections {
	...
	static List<Person> ll = new LinkedList<>();
	static Set<Person> ts = new TreeSet<>();
	static Set<Person> hs = new HashSet<>();
	static Map<Integer, Person> tm = new TreeMap<>();
	static Map<Integer, Person> hm = new HashMap<>();
	static PersonComparator x = new PersonComparator();
